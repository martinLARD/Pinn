...
class PhysicsInformedNN:
    ...
    def __init__(self, x, y, u, v, layers, coeff_k):
        ...
        self.train_op_bfgs = tfp.optimizer.lbfgs_minimize(self.loss,None,previous_optimizer_results=True)
    ...
    def train(self, nIter): 
        ...
        for it in range(nIter):
            ...
            if it % 100 == 0:
                ...
                print('It: %d, Loss data: %.3e, Loss phy: %.3e, Loss reg: %.3e, l1: %.3e, Time: %.2f' % 
                      (it, loss_data_value, loss_phy_value, loss_reg_value, lambda_1_value, elapsed))
...
# Load Data
data = np.loadtxt("C:/Users/Admin/Documents/These/work/code/data/simulation/snaps/Macro_select.dat") # i, j, rho, u, v
